...
const AboutUs = () => {
  ...
  const timelineEvents = [
    {
      ...
      description:
        "BodyMax opens its doors with a single boxing ring and a big dream.",
    },
    {
      year: "2015",
      title: "First Champion",
      description:
        "Produces Rwanda's first national boxing champion under our banner.",
    },
    {
      year: "2019",
      title: "Strategic Alliance",
      description:
        "Partners with Rwanda Boxing Federation for elite talent development.",
    },
    {
      year: "2023",
      title: "Modern Legacy",
      description:
        "State-of-the-art facility serving over 1,000 active members.",
    },
  ];
  ...
  const stats = [
    { value: "12+", label: "Years of Excellence", icon: Award, color: "blue" },
    { value: "15+", label: "Champions Trained", icon: Trophy, color: "blue" },
    { value: "1,000+", label: "Active Members", icon: Users, color: "blue" },
    { value: "98%", label: "Member Satisfaction", icon: Star, color: "blue" },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "BodyMax transformed my life. The coaches' dedication is unmatched.",
      image:
    ...
    },
    {
      ...
      content:
        "From nervous beginner to feeling unstoppable. Best decision ever.",
      image:
  ...
  const pastEvents = [
    {
      ...
      attendance: "2,500+",
      image:
        "https://images.unsplash.com/photo-1502685104226-ee32379fefbe?w=600&h=400&fit=crop",
    },
    {
      ...
      attendance: "1,800+",
      image:
        "https://images.unsplash.com/photo-1599058917765-e2014a0963ac?w=600&h=400&fit=crop",
    },
    {
  ...
  return (
    <div ref={containerRef} className="bg-white min-h-screen overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.div
                variants={fadeUp}
                className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-50 rounded-full mb-8"
              >
              ...
              <motion.h1
                variants={fadeUp}
                className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-slate-900 leading-[1.1] mb-6"
              >
                Forging
              ...
              >
                BodyMax is Rwanda's premier boxing destination — a place where
                discipline meets world-class coaching. We don't just train
                fighters; we build character, resilience, and champions.
              </motion.p>
            ...
            {/* Right Column - Image with Blue Accent Frame */}
            <motion.div
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-slate-600 leading-relaxed">
              Every punch thrown, every drop of sweat — guided by our unwavering
              values.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {coreValues.map((value, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-all hover:border-blue-200 border border-transparent group"
              >
      ...
      {/* === BODYMAX PROMOTIONS SECTION - NEW === */}
      <section className="py-28 bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 text-white overflow-hidden relative">
        {/* Abstract ring pattern background */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-10 w-64 h-64 rounded-full border-4 border-white/20" />
          <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full border-4 border-white/10" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full border-4 border-white/5" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-5">
              BODYMAX <span className="text-yellow-400">PROMOTIONS</span>
            </h2>
            <p className="text-blue-100 text-lg leading-relaxed">
              Elevating boxing in Rwanda through world-class event production,
              athlete management, and unforgettable fight nights.
            </p>
          </motion.div>

          {/* Promoter Credentials Grid */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            {promoterCredentials.map((cred, i) => (
              ...
              >
                <div className="w-12 h-12 bg-yellow-400/20 rounded-xl flex items-center justify-center mb-4 group-hover:bg-yellow-400/30 transition-colors">
                  <cred.icon className="w-6 h-6 text-yellow-400" />
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -inset-4 bg-gradient-to-r from-yellow-400/20 to-blue-500/20 rounded-3xl blur-xl" />
              <img
                src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=600&h=700&fit=crop"
                alt="Lead Promoter - John Mugisha"
                className="relative rounded-2xl shadow-2xl w-full h-auto object-cover border-2 border-white/10"
              />
              <div className="absolute -bottom-6 -right-6 bg-yellow-400 text-slate-900 rounded-full px-5 py-2 shadow-lg">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 rounded-full">
                ...
                <span className="text-xs font-medium">
                  Licensed Professional Promoter
                </span>
              </div>
              <h3 className="text-3xl font-bold">John Mugisha</h3>
              <p className="text-blue-100 text-lg leading-relaxed">
                With over a decade of experience in combat sports promotion,
                John has successfully organized more than 15 major boxing events
                across Rwanda and East Africa. His vision has brought
                international attention to Rwandan boxing talent and created
                platforms for athletes to shine on the continental stage.
              </p>
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className="border-l-2 border-yellow-400 pl-4">
                  <p className="text-2xl font-bold text-yellow-400">15+</p>
                  <p className="text-xs text-blue-200">Events Organized</p>
                </div>
                <div className="border-l-2 border-yellow-400 pl-4">
                  <p className="text-2xl font-bold text-yellow-400">5</p>
                  <p className="text-xs text-blue-200">Pro Fighters Signed</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div>
            ...
            >
              ...
              <p className="text-blue-100">
                Memorable nights that put Rwandan boxing on the map
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {pastEvents.map((event, i) => (
                <motion.div
                  ...
                  transition={{ delay: i * 0.1 }}
                  viewport={{ once: true }}
                  className="group relative overflow-hidden rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-yellow-400/30 transition-all"
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
                </motion.div>
              ))}
            </div>
          </div>

          {/* CTA within Promotions */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <button className="inline-flex items-center gap-2 px-8 py-3 bg-yellow-400 text-slate-900 font-bold rounded-full hover:bg-yellow-300 transition-all hover:scale-105 shadow-lg">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-slate-600 leading-relaxed mb-10">
                Twelve years of relentless pursuit of excellence. We've grown,
      ...
      <section className="py-28 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-slate-600 leading-relaxed">
              Guided by experts who have lived the sport and dedicated their
              lives to coaching excellence.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-16">
            {partners.map((partner, i) => (
              ...
              >
                <div className="w-24 h-24 rounded-full bg-slate-50 flex items-center justify-center mx-auto mb-3 group-hover:bg-blue-50 transition-colors overflow-hidden border border-slate-100">
                  <img
                    src={partner.logo}
                    alt={partner.name}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, i) => (
              <motion.div
                ...
                transition={{ delay: i * 0.1 }}
                viewport={{ once: true }}
                className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:border-blue-200 transition-all"
              >
                <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center mb-5">
      ...
      {/* === CTA SECTION === */}
      <section className="py-28 bg-gradient-to-br from-slate-900 to-blue-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-blue-200 text-lg mb-10 max-w-2xl mx-auto">
              Join Rwanda's premier boxing community. Whether you're a beginner
              or aspiring champion, we have a place for you.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <button className="px-10 py-4 bg-white text-slate-900 font-semibold rounded-full hover:bg-slate-100 transition-all hover:shadow-xl flex items-center gap-2">
                Become a Member
                <ArrowRight className="w-4 h-4" />
              </button>
              <button className="px-10 py-4 bg-blue-700 text-white font-semibold rounded-full hover:bg-blue-600 transition-all">
                Contact Us
              </button>
            </div>
          </motion.div>
